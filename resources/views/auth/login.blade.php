            ...
            <form method="POST" action="{{ route('login.submit') }}" class="mt-7 space-y-5">
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full rounded-2xl border border-purple-100 dark:border-slate-600 bg-purple-50/40 dark:bg-slate-700 px-4 py-4 text-sm text-slate-900 dark:text-white outline-none transition-all focus:border-purple-400 focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-purple-100 dark:focus:ring-purple-900/30 placeholder:text-slate-400 dark:placeholder:text-slate-500"
                    >
                </div>
                ...
                <a
                    href="{{ route('register') }}"
                    class="flex w-full items-center justify-center rounded-full border border-purple-300 dark:border-purple-600 bg-white dark:bg-slate-800 px-6 py-4 text-sm font-bold text-purple-800 dark:text-purple-300 transition hover:bg-purple-50 dark:hover:bg-slate-700"
                >
